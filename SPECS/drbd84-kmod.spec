...
%{!?kversion: %define kversion 3.10.0-327.36.1.el7.%{_target_cpu}}
...
# Sources.
Source0:  http://www.drbd.org/download/drbd/8.4/drbd-%{version}-1.tar.gz
...
%changelog
* Thu Sep 15 2016 Markus Frosch <markus.frosch@netways.de> - 8.4.8-1
- Initial version for 8.4
- Based on a SPEC for 9.0 by Hiroshi Fujishima <h-fujishima@sakura.ad.jp>
